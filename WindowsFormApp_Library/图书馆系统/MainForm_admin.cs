...
namespace 图书馆系统
{
    public partial class MainForm_admin : Form
    {
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            ...
            {
                //查找id
                string str4543 = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=LoginTable;integrated Security=True";
                ...
                else
                {
                    ...
                    string str77 = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=LoginTable;integrated Security=True";
                    ...
                    string str26 = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=LoginTable;integrated Security=True";
