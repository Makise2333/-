...
namespace 图书馆系统
{
    public partial class MainForm_user : Form
    {
        ...
        private void MainForm_user_Load(object sender, EventArgs e)
        {
            ...
            string str1515 = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=LoginTable;integrated Security=True";
            ...
            string str454 = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=LoginTable;integrated Security=True";
            ...
            {//不存在 创建
                string str21 = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=LoginTable;integrated Security=True";
        ...
        private void 图书一览_Click(object sender, EventArgs e)
        {
            ...
            //刷新图书信息
            string str = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=LoginTable;integrated Security=True";
        ...
        private void 借还业务_Click(object sender, EventArgs e)
        {
            ...
            string str1 = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=LoginTable;integrated Security=True";
            ...
            string str151 = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=LoginTable;integrated Security=True";
            ...
            string str1523 = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=LoginTable;integrated Security=True";
        ...
        private void 预约业务_Click(object sender, EventArgs e)
        {
            ...
            string str15 = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=LoginTable;integrated Security=True";
        ...
        private void 消息提醒_Click(object sender, EventArgs e)
        {
            ...
            string str44 = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=LoginTable;integrated Security=True";
            ...
            string str4455 = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=LoginTable;integrated Security=True";
  ...
  string str = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=LoginTable;integrated Security=True";
        ...
        {
            string str4 = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=LoginTable;integrated Security=True";
            ...
            else
            {
                ...
                if (num2 > 0)
                {
                    ...
                    conn.Close();//完成book更新
                                 //写js表
                    string str12 = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=LoginTable;integrated Security=True";
        ...
        private void button2还书按钮_Click(object sender, EventArgs e)
        {
            ...
            if (sdr4.Read())//查询到借书信息
            {
                ...
                conn.Close();
                //删除借阅
                string str9 = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=LoginTable;integrated Security=True";
                ...
                //写还书记录
                string str7 = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=LoginTable;integrated Security=True";
                ...
                //刷新图书表
                string str6 = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=LoginTable;integrated Security=True";
        ...
        private void button4预约按钮_Click(object sender, EventArgs e)
        {
            ...
            if (num2 > 0)
            {
                ...
                //刷新图书目录
                string str19 = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=LoginTable;integrated Security=True";
        ...
        {
            string str191 = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=LoginTable;integrated Security=True";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string str2 = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=LoginTable;integrated Security=True";
