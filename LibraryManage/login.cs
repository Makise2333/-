...
namespace LibraryManage
{
    public partial class login : Form
    {
        ...
        {
            InitializeComponent();
            this.BackgroundImage = Image.FromFile(@"C:/Users/Lenovo/Pictures/安徽财经大学图书馆背景照.jpg");//文件路径
        ...
        private void 注册_Click(object sender, EventArgs e)
        {
            ...
            if (用户名_text.Text != "" && 密码_text.Text != "")
            {
                ...
                if (dlflag == 2)
                {
                    ...
                    string str2 = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=BookDB;integrated Security=True";
                ...
                if (dlflag == 1)  //查找管理员
                {
                    string str3 = @"Data Source=DESKTOP-QMBQVMT;Initial catalog=BookDB;integrated Security=True";
